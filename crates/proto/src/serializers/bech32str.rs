...
pub mod validator_identity_key {
    ...
    pub const BECH32_PREFIX: &str = "verityvalid";
...
pub mod validator_governance_key {
    ...
    pub const BECH32_PREFIX: &str = "veritygovern";
...
pub mod address {
    ...
    pub const BECH32_PREFIX: &str = "verity";
...
pub mod compat_address {
    ...
    pub const BECH32_PREFIX: &str = "veritycompat1";
...
pub mod asset_id {
    ...
    pub const BECH32_PREFIX: &str = "vasset";
...
pub mod full_viewing_key {
    ...
    pub const BECH32_PREFIX: &str = "verityfullviewingkey";
...
pub mod wallet_id {
    ...
    pub const BECH32_PREFIX: &str = "veritywalletid";
...
pub mod spend_key {
    ...
    pub const BECH32_PREFIX: &str = "verityspendkey";
...
pub mod lp_id {
    ...
    pub const BECH32_PREFIX: &str = "vlpid";
...
pub mod auction_id {
    ...
    pub const BECH32_PREFIX: &str = "vauctid";
